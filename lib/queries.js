...
export const WITHDRAWAL_BANKS_QUERY = gql`
  query WithdrawalBanks {
    withdrawalBanks {
      code
      name
    }
...
export const RESOLVE_WITHDRAWAL_ACCOUNT_MUTATION = gql`
  mutation ResolveWithdrawalAccount($accountNumber: String!, $bankCode: String!) {
    resolveWithdrawalAccount(accountNumber: $accountNumber, bankCode: $bankCode) {
      success
      message
      accountName
    }
...
export const WITHDRAW_TO_BANK_MUTATION = gql`
  mutation WithdrawToBank($input: WithdrawToBankInput!) {
...
export const UPDATE_SERVICE_REQUEST_STATUS_MUTATION = gql`
  mutation UpdateServiceRequestStatus($requestId: ID!, $status: String!) {
